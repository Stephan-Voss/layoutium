...
###
### Basic scene functions and color selection.
###
class GraphicsScene(QGraphicsScene):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.activeTextItem = None  # Store active item here. The CustomGraphicsScene ensures that the GraphicsEditor and the GraphicsTextItems agree on activeTextItem.
